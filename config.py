...
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002232025730"))
...
DB_URL = os.environ.get("DB_URL", "mongodb+srv://Leechx:Leech@cluster0.wfp9vkw.mongodb.net/?appName=Cluster0")
