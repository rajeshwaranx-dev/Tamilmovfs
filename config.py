...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", -1003637227845))
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "7246154050").split()):
        ADMINS.append(int(x))
except ValueError:
